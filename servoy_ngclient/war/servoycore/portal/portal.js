			...
			$scope.cellServoyApiWrapper = function(ngGridRow, elementIndex) {
				...
				if (!cellProxies.cellServoyApi) {
					...
					cellProxies.cellServoyApi = {
							...
							trustAsHtml: $scope.servoyApi.trustAsHtml
					}
				}
